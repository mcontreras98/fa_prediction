...
def configure():
 ...
 #   flags.DEFINE_integer("max_con_epoch", 300, "max epoch for conditional part training")
    ...
    flags.DEFINE_float("learning_rate_gen", 2e-4, "learning rate generator")
...
#   flags.DEFINE_float("gamma_dec", 1e-4, "gamma ratio for decoder")
    ...
    flags.DEFINE_string("working_directory", "E:\\cgan\\model\\self",
                        "the file directory")
 ...
 #   flags.DEFINE_integer("channel", 64, "size of initial channel in decoder")
    flags.DEFINE_integer("checkpoint", 25000, "number of epochs to be reloaded")
 #   flags.DEFINE_string("model_name", 'low_rank', "vanilla or low_rank")
    ...
    flags.DEFINE_string("modeldir", 'E:\\cgan\\model\\modeldir_unet_guide', "the model directory")
    flags.DEFINE_string("logdir", 'E:\\cgan\\model\\logdir_unet_guide', "the log directory")
    flags.DEFINE_string("sampledir", 'E:\\cgan\\model\\sampledir_unet_guide', "the sample directory")
